# Generated by Django 5.2.1 on 2025-06-21 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thickness', models.IntegerField(blank=True, help_text='Thickness in mm', null=True)),
                ('length', models.IntegerField(blank=True, help_text='Length in mm', null=True)),
                ('width', models.IntegerField(blank=True, help_text='Width in mm', null=True)),
                ('surface', models.IntegerField(blank=True, help_text='Surface area (m²)', null=True)),
                ('prix_unitaire', models.FloatField(blank=True, help_text='Unit price', null=True)),
                ('quantite', models.PositiveIntegerField(default=0, help_text='Quantity in stock')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, help_text='Date when the material returned was deleted', null=True)),
                ('bon_retour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='matiere_retours', to='api.bonretour')),
                ('matiere', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='retours', to='api.matiere')),
            ],
        ),
        migrations.CreateModel(
            name='MatiereUsage',
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, help_text='Date when the material usage was deleted', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('facture', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.facturetravaux')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, help_text='Date when the work was deleted', null=True)),
                ('remise', models.FloatField(default=0, help_text='Remise appliquée sur le travail (en DT)')),
